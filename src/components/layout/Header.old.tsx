                ...
                <AnimatePresence>
                  {isDropdownOpen && (
                    ...
                    >
                      ...
                      {user.type === 'company' && (
                        <>
                          <Link to={user.companySlug ? `/dashboard/empresa/${user.companySlug}` : "/dashboard/empresa"} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">Dashboard</Link>
                          <Link to={company?.slug ? `/empresa/${company.slug}` : "/empresa/meu-negocio"} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">Ver Página Pública</Link>
                        </>
                      )}
                  ...
                  {user ? (
                    <div className="space-y-1">
                      {user.type === 'client' ? (
                        ...
                        <>
                          <Link to={user.companySlug ? `/dashboard/empresa/${user.companySlug}` : "/dashboard/empresa"} className="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg">Dashboard</Link>
                        </>
                      )}
                      <button
                        onClick={handleLogout}
