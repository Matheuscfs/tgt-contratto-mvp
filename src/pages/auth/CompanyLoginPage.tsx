                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div className="mb-10">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            Gerencie seus serviços e receba novos pedidos.
                        </p>
                    </div>
                                ...
                                <div className="flex">
                                    ...
                                    <div className="ml-3 flex-1">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            >
                                                Ir para login de clientes &rarr;
                                            </Link>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="hidden lg:block relative w-0 flex-1 bg-[#004E89]">
                ...
                <div className="relative h-full flex flex-col items-center justify-center p-12 text-white">
                    ...
                    <p className="text-lg text-blue-100/80 text-center max-w-lg mb-12">
                        Receba pedidos qualificados, gerencie contratos e cresça sua reputação no mercado.
                    </p>

                    {/* Floating Cards Illustration Placeholder - Company Version */}
