        ...
        try {
            const { data, error } = await supabase.auth.signUp({
                ...
                options: {
                    data: {
                        name: formData.name,
                        type: 'company' // Explicitly set as company
                    }
                }
            });
            ...
            if (data.user) {
                addToast('Conta criada com sucesso! Faça login para cadastra sua empresa.', 'success');
            ...
            <div className="max-w-md w-full space-y-8 p-10 bg-white shadow-lg rounded-lg border-t-4 border-brand-primary">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Divulgue seus serviços para milhares de clientes. <br />
                        Já tem uma conta?{' '}
