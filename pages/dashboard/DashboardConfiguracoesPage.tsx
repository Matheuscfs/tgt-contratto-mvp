         ...
         <div className="pt-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    <input type="time" defaultValue="09:00" className="border-gray-300 rounded-md shadow-sm"/>
                    <span>às</span>
                     <input type="time" defaultValue="18:00" className="border-gray-300 rounded-md shadow-sm"/>
                </div>
            </div>
         </div>
          <div className="pt-5">
