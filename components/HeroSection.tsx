                ...
                <div className="grid md:grid-cols-[65%_35%] gap-8 items-end">
                    ...
                    <div className="mb-8 md:mb-16">
                        <AnimatedSection delay={0.2} className="bg-white/10 backdrop-blur-sm p-8 rounded-sharp border border-white/20 shadow-2xl">
                            ...
                            <div className="mt-6 flex items-center gap-4 text-sm font-medium opacity-80">
                                <div className="flex -space-x-2">
                                    {[1, 2, 3].map(i => (
                                        <div key={i} className="w-8 h-8 rounded-full bg-brand-accent border-2 border-brand-primary" />
                                    ))}
                                </div>
                                <span>+12k profissionais verificados</span>
                            </div>
                        </AnimatedSection>
                    </div>
                </div>
